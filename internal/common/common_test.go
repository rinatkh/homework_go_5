...
func TestReadFileOrDefault(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{"a.txt", "hello", "def", "hello", true},
		{"empty.txt", "", "def", "", true},
		{"missing.txt", "", "def", "def", false},
		{"rus.txt", "рус", "def", "рус", true},
		{"lines.txt", "a\nb", "def", "a\nb", true},
		{"space.txt", " space ", "def", " space ", true},
		{"zero.txt", "0", "def", "0", true},
		{"bang.txt", "!", "def", "!", true},
		{"missing2.txt", "", "", "", false},
		{"long.txt", "abcdef", "x", "abcdef", true},
	} {
